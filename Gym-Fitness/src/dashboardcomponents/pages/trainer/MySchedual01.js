...
const MySchedual01 = () => {
  ...
  useEffect(() => {
    ...
    const url =
      `/sessions?start=${encodeURIComponent(fmt(startDate))}` +
      ...
      .then((res) => {
        ...
        const grouped = res.data
          ...
          .reduce((acc, s) => {
            ...
            acc[day].push({
              ...s,
              formattedTime: new Date(s.sessionDatetime).toLocaleTimeString(
                [],
  ...
  const renderCells = () => {
    ...
    return slots.map((slot, idx) => {
      ...
      return (
        <div
          key={idx}
          className={`${styles.date} ${!slot ? styles.faded : ""}`}
        >
              ...
              {sessions[slot].map((sess) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={styles.eventTime}>{sess.formattedTime}</div>
  ...
  return (
    <div className={styles.myschedule_headcontainer}>
      {/* Left-part */}
      ...
      <div className={styles.nextoverview01}>
        ...
        <div className={styles.nextsection01}>
          <div className={styles.menuItemdb1}>
            ...
            <Link to="/overviews1" className={styles.menulinksdb}>
              {" "}
              Overview{" "}
            </Link>
          </div>
          ...
          <div className={styles.menuItemdb1}>
            ...
            <Link to="/memberlists" className={styles.menulinksdb}>
              {" "}
              Member{" "}
            </Link>
          </div>
          <div className={styles.menuItemdb1}>
            ...
            <Link to="/myschedual01" className={styles.menulinksdb}>
              {" "}
              My Schedule{" "}
            </Link>
          </div>
          ...
          <div className={styles.nextsection02}>
            <div className={styles.menuItemdb01}>
              ...
              <Link to="/myprofile" className={styles.menulinksdb}>
                {" "}
                My Profile{" "}
              </Link>
            </div>
            <div className={styles.menuItemdb01}>
              ...
              <Link to="/" className={styles.menulinksdb}>
                {" "}
                Logout{" "}
              </Link>
            </div>
      ...
      <div className={styles.nextoverview02}>
        ...
        <div className={styles.calenbody}>{renderCells()}</div>
        ...
        <div className={styles.maincalenders}>
          <div className={styles.maincalenders01}>
            <div className={styles.smallminicalender01}>
              ...
              <Link to="/create-session" className={styles.schedualtext02}>
                {" "}
                Create Schedual
              </Link>
            </div>
