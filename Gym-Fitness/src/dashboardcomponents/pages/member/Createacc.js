...
const Createacc = () => {
 ...
 <button className={styles.topButton} >  <Link to="/" className={styles.linktopbtn}>SIGNIN / SIGNUP</Link > </button> 
    </header>
...
/>
      ...
      <div className={styles.socialbtn2}>    <img src={facebook} alt="" className={styles.icon} /> <Link to="/" className={styles.socialBtn}> Facebook</Link> </div> 
        ...
        Already have an account? <Link to="/" className={styles.signupLink}>SignIn</Link>
        </div>
      </div>
    </div>
  </div>
